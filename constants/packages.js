export const packages = [
  {
    category: "Cabina Foto",
    packages: [
      {
        title: "Pachet 3 ore",
        features: [
          "Printuri nelimitate",
          "Recuzită distractivă",
          "Poze magnetice",
          "Design personalizat a fotografiei",
          "Asistență pe toată durata evenimentului",
        ],
        price: 800,
      },
      {
    ...
    packages: [
      {
        ...
        features: [
          ...
          "Fundaluri din stoc",
          "Imprimare pe magnet",
          "Design personalizat pentru rame foto",
    ...
    packages: [
      {
        ...
        features: [
          ...
          "Logo personalizat pe video",
          "Partajare clipurilor la finalul evenimentului",
          "Asistent pe toată durata evenimentului",
        ],
        price: 800,
      },
